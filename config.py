...
chromedriver_path      = ""      # set to path of chromedriver.exe | leave blank to use default/auto
chromedriver_mode      = 0       # 0 : "headless" or 1 : "normal" or 2 : "maximized"
chromedriver_pool_size = 2       # set to number of chromedriver instances to run in parallel
chromedriver_timeout   = 10      # set to number of seconds to wait for a chromedriver instance to become available
